   ...
   begin
      ...
      while Object_Cur_1 /= Object_List.No_Element loop
         ...
         while Object_Cur_2 /= Object_List.No_Element loop
            declare
               Dx : Coordinate_Type := Get_X (Element (Object_Cur_1).all)
                 - Get_X (Element (Object_Cur_2).all);
               Dy : Coordinate_Type := Get_Y (Element (Object_Cur_1).all)
                 - Get_Y (Element (Object_Cur_2).all);
               Dist_Min : Coordinate_Type :=
                 Get_Radius (Element (Object_Cur_1).all)
                 + Get_Radius (Element (Object_Cur_2).all);
            begin
