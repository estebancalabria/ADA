...
package Invaders.Objects is
   ...
   --  Implementation of Invaders_Physics

   function Get_X (V : Root_Object'Class) return Float;
   function Get_Y (V : Root_Object'Class) return Float;
   function Get_Radius (V : Root_Object'Class) return Float;
   procedure Set_X (V : in out Root_Object'Class; Value : Float);
   procedure Set_Y (V : in out Root_Object'Class; Value : Float);

   package Invaders_Physics is new Physics
     (Root_Object'Class, Float, Get_X, Get_Y, Get_Radius, Set_X, Set_Y);
