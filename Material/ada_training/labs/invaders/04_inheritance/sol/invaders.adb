...
package body Invaders is
   ...
   procedure Free is new Ada.Unchecked_Deallocation (Ammo, Ammo_Access);
   procedure Free is new Ada.Unchecked_Deallocation (Foe, Foe_Access);
   ...
   function Get_Player (The_Game : Game_Record) return Player_Access is
   begin
   ...
   overriding procedure Redraw (This : in out Player) is
   begin
      Set_X (This.Graphic, This.X);
      Set_Y (This.Graphic, This.Y);
   end Redraw;

   overriding procedure Redraw (This : in out Foe) is
   begin
      Set_X (This.Graphic, This.X);
      Set_Y (This.Graphic, This.Y);
   end Redraw;

   overriding procedure Redraw (This : in out Ammo) is
   begin
      Set_Y (This.Graphic, This.Y);
